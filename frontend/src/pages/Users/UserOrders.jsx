...
const UserOrders = () => {
  ...
  const categorizedOrders = {
    active: orders.filter((order) =>
      ["pending", "confirmed", "preparing", "ready", "cancelled"].includes(
        order.status
      )
    ),
      ...
      <div className={styles.ordersContainer}>
        <div className={styles.authRequired}>
          ...
          <button
            ...
            onClick={() =>
              navigate(
                `/restaurant/${restaurantId}/table/${tableNumber}/account`
              )
            }
          >
            Go to Login
                ...
                <div key={order._id} className={styles.orderCard}>
                  ...
                  {activeTab === "active" && order.status !== "cancelled" && (
                    <div className={styles.orderProgress}>
                      ...
                      <div className={styles.progressSteps}>
                        ...
                        <span
                          className={`${styles.progressStep} ${
                            ["ready", "completed", "served"].includes(
                              order.status
                            )
                              ? styles.completed
                              : styles.pending
                  ...
                  {activeTab === "active" && order.status === "preparing" && (
                    <div className={styles.estimatedTime}>
                      ...
                      Your order is being prepared. Estimated time: 15-20
                      minutes
                    </div>
                  )}
